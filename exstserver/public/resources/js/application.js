...
define("Views/AddCheckboxFieldForm", ["Views/Base"], function(Page){
    return Page.extend({},{
...
define("Views/AddTextFieldForm",["Views/Base"], function(Page){
    return Page.extend({},{
        defaults: $.extend(true, {}, Page.defaults, {
            tpl: {
...
define("Views/Breadcrumb",["Views/Base"], function(View){
    return View.extend({},{
 ...
 * Created by Mantsevich on 21.07.2014.
 */
define("Views/Pages/404", ["Views/Page"], function(Page){
    return Page.extend({},{
        defaults: $.extend(true, {}, Page.defaults, {
            tpl: {
 ...
 * Created by Administrator on 28.07.2014.
 */
define("Views/Pages/Employers", ["Views/Page"], function(Page){
    return Page.extend({},{
        defaults: $.extend(true, {}, Page.defaults, {
            tpl: {
 ...
 * Created by Administrator on 28.07.2014.
 */
define("Views/Pages/Forgot",  ["Views/Page"],function(Page){
   return Page.extend({},{
      defaults: $.extend(true, {}, Page.defaults, {
          tpl:{
...
define("Views/Pages/Settings", ["Views/Page", "jquery"], function(Page, $){
    return Page.extend({},{
        defaults: $.extend(true, {}, Page.defaults, {
            tpl: {
